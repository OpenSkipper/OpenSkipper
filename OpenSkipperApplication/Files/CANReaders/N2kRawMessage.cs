...
namespace CANReaders
{
    public class N2kRawMessage
    {
        ...
        public void Parse()
        {
            CreateCanID(CanID, out int priority, out int pgn, out int source, out int destination);
        ...
        /// </remarks>
        public void CreateCanID(int canid, out int priority, out int pgn, out int source, out int destination)
        {
        ...
        /// Original Source: https://github.com/canboat/canboat/blob/master/common/common.c
        /// </remarks>
        public void ParseCanID(int canid, out int priority, out int pgn, out int source, out int destination)
        {
            #region Documentation
            /*
            * ------------------------------------------------------------------------------------------------
